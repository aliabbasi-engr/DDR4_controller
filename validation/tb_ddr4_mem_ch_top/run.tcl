...
foreach {library file_list} $library_file_list {
	...
	if { $last_compile_time < [file mtime $file] } {
		...
		vlog -incr -sv $file \
			"+incdir+../../implementation/syn/mem_ctrl/" \
			"+incdir+$PHY_PATH/mig_phy.srcs/sources_1/ip/ddr4_0/ip_1/rtl/map" \
			"+incdir+$PHY_PATH/mig_phy.srcs/sources_1/ip/ddr4_0/tb/ddr4_model" \
...
eval vsim -voptargs="+acc" -t ps \
	-L microblaze_v11_0_1 \
	-L blk_mem_gen \
	-L xi_phy \
	-L lib_cdc_v1_0_2 \
