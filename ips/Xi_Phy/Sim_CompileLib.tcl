...
compile_simlib -simulator questasim -simulator_exec_path $MODELSIM_EXE_PATH -family all -language all -library all -dir $SIM_LIB_PATH/compile_simlib/modelsim -force
